    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Clothes-R-Us  ©  Shlomi Biton                   ", Snackbar.LENGTH_LONG)
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.navigation_womens:
                    intent = new Intent(MainActivity.this, WOMENSActivity.class);
                    startActivity(intent);
                    return true;
                case R.id.navigation_mens:
                    intent = new Intent(MainActivity.this, MENSActivity.class);
                    startActivity(intent);
                    return true;
